        ...
        <div class="content p-4">
            ...
            <div class="row mt-4">
                <div class="col-md-4 mb-4">
                    <div class="col-auto">
                        <img src="../assets/image/placeholder-item.png" class="img-fluid border" alt="Product Image">
                    </div>
                </div>
                ...
                <div class="col-md-8 mb-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control bg-white" id="product-name" value="Bag Name"
                                disabled>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row mt-2 gx-1">
                        <div class="col mb-3">
                            ...
                            <textarea class="form-control bg-white" id="description" rows="4"
                                disabled>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur maiores hic aut doloribus nulla. Sit iusto impedit est commodi ab. Adipisci, non aperiam! Perferendis repudiandae, autem reprehenderit natus laboriosam assumenda.</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
