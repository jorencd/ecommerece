...
<body>
  ...
  <nav class="navbar bg-body-tertiary fixed-top shadow-sm py-0">
    <div class="container-fluid">
      <!-- Left Arrow Icon -->
      <a class="navbar-brand" href="refunded-order.php">
  ...
  <div class="container-fluid mt-5 pt-4">
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <p class="text-success fw-bold">Your order has been refunded.</p>
      </div>
    </div>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <p><strong>Refund Amount: </strong>$120.00</p>
        <p><strong>Refund Date: </strong>2024-09-18</p>
    ...
    <div class="alert alert-info text-center mt-4">
      <i class="bi bi-info-circle-fill"></i> Your refund has been successfully processed. If you have any questions, please contact our support team.
    </div>
  </div>
